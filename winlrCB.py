...
if SNnumber not in pm_list_1_1_1:
    ...
    try:
        auto.EditControl(Name='File name:').SendKeys('CB.Scenario')
    except LookupError:
        auto.EditControl(Name='文件名(N):').SendKeys('CB.Scenario')
    try:
    ...
    window_tittle_1 = app_connect.window(title='[CB] wiLongRun')
    ...
    pm_list_1_1_1[SNnumber] = 'WinLRCB'

...
pm_list_1.close()
shutil.copy(r'C:\TNB_Integration_Tool\wiLongRun\Combined.Scenario',os.path.join('C:\\Users',user,'Documents'))
if SNnumber not in pm_list_1_1_1:
    ...
    newpm_1_1 = ',' + ' ' + '"' + SNnumber + '"' + ':' + ' ' + '"' + 'WinLRCombined' + '"' + '}'
    ...
    try:
        auto.EditControl(Name='File name:').SendKeys('Combined.Scenario')
    except LookupError:
        auto.EditControl(Name='文件名(N):').SendKeys('Combined.Scenario')
    try:
    ...
    window_tittle_1 = app_connect.window(title='[Combined] wiLongRun')
    window_tittle_1.child_window(title="The Settings and optional for the overall test scenario.", control_type="Text").click_input()
    ...
    pm_list_1_1_1[SNnumber] = 'WinLRCombined'

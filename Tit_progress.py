...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def HJSZ(slef):
        if os.path.exists(r'C:\WDTFInstallText.log'):
            os.system(r'C:\TNB_Integration_Tool\SetPrerequisites_v3.0\Prepare.bat')
            time.sleep(5)
            subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\SetPrerequisites.ps1'])
            time.sleep(22)
    ...
    def AC_MS(self):
        ...
        if SNnumber not in pm_list_1_1_1:
            ...
            newpm_1.close()
            for file_1 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_1.endswith('csv') or file_1.endswith('htm') or file_1.endswith('html') or file_1.endswith('txt') or file_1.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_1))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
            time.sleep(7)
            try:
            ...
            for file_2 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_2.endswith('csv') or file_2.endswith('htm') or file_2.endswith('html') or file_2.endswith('txt') or file_2.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_2))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
    ...
    def DC_MS(self):
        ...
        pm_list_2 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
        pm_list_2_2 = pm_list_2.read()
        pm_list_2_2_2 = json.loads(pm_list_2_2)
        pm_list_2.close()
        if SNnumber not in pm_list_2_2_2:
            pm_class_2 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
            pm_class_2_2 = pm_class_2.read().rstrip("}")
            pm_class_2_2_2 = str(pm_class_2_2)
            pm_class_2.close()
            newpm_2 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            newpm_2_2 = ',' + ' ' + '"' + SNnumber + '"' + ':' + ' ' + '"' + self.label.text() + '"' + '}'
            newpm_2.write(pm_class_2_2_2 + newpm_2_2)
            newpm_2.close()
            for file_3 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_3.endswith('csv') or file_3.endswith('htm') or file_3.endswith('html') or file_3.endswith('txt') or file_3.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_3))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
            ...
            pm_list_2_2_2_2_2 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            pm_list_2_2_2_2_2_2 = pm_list_2_2_2_2_2.write(pm_list_2_2_2_2)
            pm_list_2_2_2_2_2.close()
            for file_4 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_4.endswith('csv') or file_4.endswith('htm') or file_4.endswith('html') or file_4.endswith(
                        'txt') or file_4.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_4))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
    ...
    def AC_S4(self):
        ...
        pm_list_3 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
        pm_list_3_3 = pm_list_3.read()
        pm_list_3_3_3 = json.loads(pm_list_3_3)
        pm_list_3.close()
        if SNnumber not in pm_list_3_3_3:
            pm_class_3 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
            pm_class_3_3 = pm_class_3.read().rstrip("}")
            pm_class_3_3_3 = str(pm_class_3_3)
            pm_class_3.close()
            newpm_3 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            newpm_3_3 = ',' + ' ' + '"' + SNnumber + '"' + ':' + ' ' + '"' + self.label.text() + '"' + '}'
            newpm_3.write(pm_class_3_3_3 + newpm_3_3)
            newpm_3.close()
            for file_5 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_5.endswith('csv') or file_5.endswith('htm') or file_5.endswith('html') or file_5.endswith(
                        'txt') or file_5.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_5))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
            ...
            pm_list_3_3_3_3_3 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            pm_list_3_3_3_3_3_3 = pm_list_3_3_3_3_3.write(pm_list_3_3_3_3)
            pm_list_3_3_3_3_3.close()
            for file_6 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_6.endswith('csv') or file_6.endswith('htm') or file_6.endswith('html') or file_6.endswith('txt') or file_6.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_6))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
    ...
    def DC_S4(self):
        ...
        pm_list_4 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
        pm_list_4_4 = pm_list_4.read()
        pm_list_4_4_4 = json.loads(pm_list_4_4)
        pm_list_4.close()
        if SNnumber not in pm_list_4_4_4:
            pm_class_4 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
            pm_class_4_4 = pm_class_4.read().rstrip("}")
            pm_class_4_4_4 = str(pm_class_4_4)
            pm_class_4.close()
            newpm_4 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            newpm_4_4 = ',' + ' ' + '"' + SNnumber + '"' + ':' + ' ' + '"' + self.label.text() + '"' + '}'
            newpm_4.write(pm_class_4_4_4 + newpm_4_4)
            newpm_4.close()
            for file_7 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_7.endswith('csv') or file_7.endswith('htm') or file_7.endswith('html') or file_7.endswith(
                        'txt') or file_7.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_7))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
            ...
            pm_list_4_4_4_4_4 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            pm_list_4_4_4_4_4_4 = pm_list_4_4_4_4_4.write(pm_list_4_4_4_4)
            pm_list_4_4_4_4_4.close()
            for file_8 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_8.endswith('csv') or file_8.endswith('htm') or file_8.endswith('html') or file_8.endswith('txt') or file_8.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_8))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
    ...
    def AC_WB(self):
        ...
        pm_list_5 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
        pm_list_5_5 = pm_list_5.read()
        pm_list_5_5_5 = json.loads(pm_list_5_5)
        pm_list_5.close()
        if SNnumber not in pm_list_5_5_5:
            pm_class_5 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
            pm_class_5_5 = pm_class_5.read().rstrip("}")
            pm_class_5_5_5 = str(pm_class_5_5)
            pm_class_5.close()
            newpm_5 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            newpm_5_5 = ',' + ' ' + '"' + SNnumber + '"' + ':' + ' ' + '"' + self.label.text() + '"' + '}'
            newpm_5.write(pm_class_5_5_5 + newpm_5_5)
            newpm_5.close()
            for file_9 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_9.endswith('csv') or file_9.endswith('htm') or file_9.endswith('html') or file_9.endswith(
                        'txt') or file_9.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_9))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
            ...
            pm_list_5_5_5_5_5 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            pm_list_5_5_5_5_5_5 = pm_list_5_5_5_5_5.write(pm_list_5_5_5_5)
            pm_list_5_5_5_5_5.close()
            for file_10 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_10.endswith('csv') or file_10.endswith('htm') or file_10.endswith('html') or file_10.endswith(
                        'txt') or file_10.endswith('bin'): os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_10))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
    ...
    def DC_WB(self):
        ...
        pm_list_6 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
        pm_list_6_6 = pm_list_6.read()
        pm_list_6_6_6 = json.loads(pm_list_6_6)
        pm_list_6.close()
        if SNnumber not in pm_list_6_6_6:
            pm_class_6 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
            pm_class_6_6 = pm_class_6.read().rstrip("}")
            pm_class_6_6_6 = str(pm_class_6_6)
            pm_class_6.close()
            newpm_6 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            newpm_6_6 = ',' + ' ' + '"' + SNnumber + '"' + ':' + ' ' + '"' + self.label.text() + '"' + '}'
            newpm_6.write(pm_class_6_6_6 + newpm_6_6)
            newpm_6.close()
            for file_11 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_11.endswith('csv') or file_11.endswith('htm') or file_11.endswith('html') or file_11.endswith(
                        'txt') or file_11.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_11))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
            ...
            pm_list_6_6_6_6_6 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            pm_list_6_6_6_6_6_6 = pm_list_6_6_6_6_6.write(pm_list_6_6_6_6)
            pm_list_6_6_6_6_6.close()
            for file_12 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                if file_12.endswith('csv') or file_12.endswith('htm') or file_12.endswith('html') or file_12.endswith('txt') or file_12.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file_12))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            #subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\LongRunATS_AOAC.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_AOAC_v5\Run.bat')
    ...
    def FSU(self):
        ...
        pm_list_7 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
        pm_list_7_7 = pm_list_7.read()
        pm_list_7_7_7 = json.loads(pm_list_7_7)
        pm_list_7.close()
        if SNnumber not in pm_list_7_7_7:
            pm_class_7 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
            pm_class_7_7 = pm_class_7.read().rstrip("}")
            pm_class_7_7_7 = str(pm_class_7_7)
            pm_class_7.close()
            newpm_7 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            newpm_7_7 = ',' + ' ' + '"' + SNnumber + '"' + ':' + ' ' + '"' + self.label.text() + '"' + '}'
            newpm_7.write(pm_class_7_7_7 + newpm_7_7)
            newpm_7.close()
            for file_13 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5'):
                if file_13.endswith('csv') or file_13.endswith('htm') or file_13.endswith('html') or file_13.endswith(
                        'txt') or file_13.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5', file_13))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            # subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\LongRunATS_Shutdown.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_Shutdown_v5\Run.bat')
            time.sleep(7)
            auto.SendKeys('{Enter}')
            time.sleep(7)
            auto.RadioButtonControl(Name='Silent').Click()
            ...
            pm_list_7_7_7_7_7 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            pm_list_7_7_7_7_7_7 = pm_list_7_7_7_7_7.write(pm_list_7_7_7_7)
            pm_list_7_7_7_7_7.close()
            for file_14 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5'):
                if file_14.endswith('csv') or file_14.endswith('htm') or file_14.endswith('html') or file_14.endswith('txt') or file_14.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5', file_14))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            # subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\LongRunATS_Shutdown.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_Shutdown_v5\Run.bat')
    ...
    def S5(self):
        ...
        pm_list_8 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
        pm_list_8_8 = pm_list_8.read()
        pm_list_8_8_8 = json.loads(pm_list_8_8)
        pm_list_8.close()
        if SNnumber not in pm_list_8_8_8:
            pm_class_8 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
            pm_class_8_8 = pm_class_8.read().rstrip("}")
            pm_class_8_8_8 = str(pm_class_8_8)
            pm_class_8.close()
            newpm_8 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            newpm_8_8 = ',' + ' ' + '"' + SNnumber + '"' + ':' + ' ' + '"' + self.label.text() + '"' + '}'
            newpm_8.write(pm_class_8_8_8 + newpm_8_8)
            newpm_8.close()
            for file_15 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5'):
                if file_15.endswith('csv') or file_15.endswith('htm') or file_15.endswith('html') or file_15.endswith(
                        'txt') or file_15.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5', file_15))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            # subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\LongRunATS_Shutdown.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_Shutdown_v5\Run.bat')
            ...
            pm_list_8_8_8_8_8 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt', 'w+')
            pm_list_8_8_8_8_8_8 = pm_list_8_8_8_8_8.write(pm_list_8_8_8_8)
            pm_list_8_8_8_8_8.close()
            for file_16 in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5'):
                if file_16.endswith('csv') or file_16.endswith('htm') or file_16.endswith('html') or file_16.endswith('txt') or file_16.endswith('bin'):
                    os.remove(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5', file_16))
            os.system('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\ClearLog.bat')
            time.sleep(39)
            # subprocess.Popen(['powershell', 'C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\LongRunATS_Shutdown.ps1'])
            os.system(r'C:\TNB_Integration_Tool\LongRunATS_Shutdown_v5\Run.bat')
    ...
    def ATSLGCK(self):
        lgck_1 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
    ...
    def jindu(self):
        ProjectConfirm_1_copyt = open(
            '\\\\192.168.1.225\\pm_tool\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\winlrtool.txt')
        ...
        data_1tt = open('\\\\192.168.1.225\\pm_tool\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
    ...
    def tool_copy(self):
        if os.path.exists('C:\\TNB_Integration_Tool'):
            ...
            ProjectConfirm_1_copy = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\winlrtool.txt')
            ...
            data_1t = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
    ...
    def SUTADD(self):
        data_1_s = open('\\\\192.168.1.225\\pm_tool\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
        ...
        if SNnumber in list_1_s:
            ...
            if ok_2_s:
                ...
                if ok_3_s:
                    phase_s = text_3_s
                    data_1_s_s = open('\\\\192.168.1.225\\pm_tool\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
                    data_1_s_s_s = data_1_s_s.read().rstrip("}")
                    data_1_s_s_s_s = str(data_1_s_s_s)
                    data_1_s_s.close()
                    new_data_s = open('\\\\192.168.1.225\\pm_tool\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
                    ...
                    if project_s == 'L13_AMD' or project_s == 'L13_Intel' or project_s == 'L1415_AMD' or project_s == 'L1415_Intel' or project_s == 'L1415_2_AMD' or project_s == 'L1415_2_Intel' or project_s == 'L13_2_AMD' or project_s == 'L13_2_Intel':
                        data_1_s_y = open('\\\\192.168.1.225\\pm_tool\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\winlrtool.txt')
                        data_1_s_s_y = data_1_s_y.read().rstrip("}")
                        data_1_s_s_s_y = str(data_1_s_s_y)
                        data_1_s_y.close()
                        new_data_ww = open('\\\\192.168.1.225\\pm_tool\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\winlrtool.txt', 'w+')
    ...
    def ATSLOG(self):
        log_pm = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\PM_CLASS.txt')
        log_pm_1 = log_pm.read()
        log_pm_1_1 = json.loads(log_pm_1)
        log_pm.close()
        if log_pm_1_1[SNnumber] == 'AC MS':
            data_1 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_1:
                ...
                if result_1 == QMessageBox.No:
                    ...
                    os.system('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\batteryreport.bat')
                    time.sleep(1)
                    try:
                        shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                    os.path.join('\\\\192.168.1.225', 'LR_Log', project_1, path_1, 'AC_S0i3',
                                                 folder_1))
                    except FileNotFoundError:
                        time.sleep(1)
                    try:
                        shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\System.evtx',
                                    os.path.join('\\\\192.168.1.225', 'LR_Log', project_1, path_1, 'AC_S0i3',
                                                 folder_1))
                    except FileNotFoundError:
                        time.sleep(1)
                    ...
                    if os.path.getsize('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\LongRunATS_AOAC_Log.htm') == 0:
                        os.system('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\sleepstudy.bat')
                        time.sleep(7)
                    for file in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                        if fnmatch.fnmatch(file, '*.htm') or fnmatch.fnmatch(file, '*.html') or fnmatch.fnmatch(file,
                                                                                                                '*.csv'):
                            shutil.move(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file),
                                        os.path.join('\\\\192.168.1.225', 'LR_Log', project_1, path_1,
                                                     'AC_S0i3',
                                                     folder_1))
                    os.system('start' + ' ' + '"' + '"' + ' ' + '"' + os.path.join('\\\\192.168.1.225', 'LR_Log',
                                                                                   project_1) + '"')
                    ...
                    if ok_1:
                        ...
                        os.makedirs(
                            os.path.join('\\\\192.168.1.225', 'LR_Log', project_1, new_path_1, 'AC_S0i3', new_folder_1))
                        os.system('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\batteryreport.bat')
                        time.sleep(1)
                        try:
                            shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                        os.path.join('\\\\192.168.1.225', 'LR_Log', project_1, new_path_1, 'AC_S0i3',
                                                     new_folder_1))
                        except FileNotFoundError:
                            time.sleep(1)
                        try:
                        ...
                        if os.path.exists('C:\\Windows\\Memory.DMP'):
                            QMessageBox.information(MainWindow, '提示', '有memorydump生成,若需要请自行在本地收集')
                        if os.path.getsize(
                                'C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\LongRunATS_AOAC_Log.htm') == 0:
                            os.system('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\sleepstudy.bat')
                            time.sleep(7)
                        for file in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                            if fnmatch.fnmatch(file, '*.htm') or fnmatch.fnmatch(file, '*.html') or fnmatch.fnmatch(
                                    file, '*.csv'):
                                shutil.move(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file),
                                            os.path.join('\\\\192.168.1.225', 'LR_Log', project_1, new_path_1,
                                                         'AC_S0i3',
                                                         new_folder_1))
                        ...
                        data_1_1_1 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
            ...
            data_3 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_3:
                ...
                if result_3 == QMessageBox.No:
                    ...
                    try:
                        shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                    os.path.join('\\\\192.168.1.225', 'LR_Log', project_3, path_3, 'DC_S0i3',
                                                 folder_3))
                    except FileNotFoundError:
                        time.sleep(1)
                    try:
                    ...
                    if ok_3:
                        ...
                        new_folder_3 = system + '_' + newphase_3 + '_' + SKU_3 + '_' + 'DC' + '_' + 'S0i3' + '_' + curent_time_1
                        os.makedirs(
                            os.path.join('\\\\192.168.1.225', 'LR_Log', project_3, new_path_3, 'DC_S0i3', new_folder_3))
                        os.system('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\batteryreport.bat')
                        time.sleep(1)
                        try:
                            shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                        os.path.join('\\\\192.168.1.225', 'LR_Log', project_3, new_path_3, 'DC_S0i3',
                                                     new_folder_3))
                        except FileNotFoundError:
                            time.sleep(1)
                        try:
                        ...
                        if os.path.getsize(
                            ...
                            time.sleep(7)
                        for file in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                            if fnmatch.fnmatch(file, '*.htm') or fnmatch.fnmatch(file,
                                                                                 '*.html') or fnmatch.fnmatch(
                                file, '*.csv'):
                                shutil.move(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file),
                                            os.path.join('\\\\192.168.1.225', 'LR_Log', project_3, new_path_3,
                                                         'DC_S0i3',
                                                         new_folder_3))
                        ...
                        data_3_3_3 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
            ...
            data_5 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_5:
                ...
                if result_5 == QMessageBox.No:
                    os.makedirs(
                        os.path.join('\\\\192.168.1.225', 'LR_Log', project_5, path_5, 'AC_S4',
                                     folder_5))
                    os.system('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\batteryreport.bat')
                    time.sleep(1)
                    try:
                    ...
                    if ok_5:
                        ...
                        os.makedirs(
                            os.path.join('\\\\192.168.1.225', 'LR_Log', project_5, new_path_5, 'AC_S4', new_folder_5))
                        os.system('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\batteryreport.bat')
                        time.sleep(1)
                        try:
                            shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                        os.path.join('\\\\192.168.1.225', 'LR_Log', project_5, new_path_5, 'AC_S4',
                                                     new_folder_5))
                        except FileNotFoundError:
                            time.sleep(1)
                        try:
                        ...
                        for file in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                            if fnmatch.fnmatch(file, '*.htm') or fnmatch.fnmatch(file, '*.html') or fnmatch.fnmatch(
                                    file, '*.csv'):
                                shutil.move(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file),
                                            os.path.join('\\\\192.168.1.225', 'LR_Log', project_5, new_path_5,
                                                         'AC_S4',
                                                         new_folder_5))
                        ...
                        data_5_5_5 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
            ...
            data_7 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_7:
                ...
                if result_7 == QMessageBox.No:
                    ...
                    try:
                        shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                    os.path.join('\\\\192.168.1.225', 'LR_Log', project_7, path_7, 'DC_S4',
                                                 folder_7))
                    except FileNotFoundError:
                        time.sleep(1)
                    try:
                    ...
                    if ok_7:
                        ...
                        os.makedirs(
                            os.path.join('\\\\192.168.1.225', 'LR_Log', project_7, new_path_7, 'DC_S4', new_folder_7))
                        os.system('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\batteryreport.bat')
                        time.sleep(1)
                        try:
                            shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                        os.path.join('\\\\192.168.1.225', 'LR_Log', project_7, new_path_7, 'DC_S4',
                                                     new_folder_7))
                        except FileNotFoundError:
                            time.sleep(1)
                        try:
                        ...
                        data_7_7_7 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
            ...
            data_9 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_9:
                ...
                if result_9 == QMessageBox.No:
                    ...
                    try:
                        shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                    os.path.join('\\\\192.168.1.225', 'LR_Log', project_9, path_9, 'AC_R',
                                                 folder_9))
                    except FileNotFoundError:
                        time.sleep(1)
                    try:
                    ...
                    if ok_9:
                        ...
                        try:
                            shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                        os.path.join('\\\\192.168.1.225', 'LR_Log', project_9, new_path_9, 'AC_R',
                                                     new_folder_9))
                        except FileNotFoundError:
                            time.sleep(1)
                        try:
                        ...
                        data_9_9_9 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
            ...
            data_11 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_11:
                ...
                if result_11 == QMessageBox.No:
                    ...
                    try:
                        shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                    os.path.join('\\\\192.168.1.225', 'LR_Log', project_11, path_11, 'DC_R',
                                                 folder_11))
                    except FileNotFoundError:
                        time.sleep(1)
                    try:
                    ...
                    for file in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5'):
                        if fnmatch.fnmatch(file, '*.htm') or fnmatch.fnmatch(file, '*.html') or fnmatch.fnmatch(
                                file, '*.csv'):
                            shutil.move(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5', file),
                                        os.path.join('\\\\192.168.1.225', 'LR_Log', project_11, path_11,
                                                     'DC_R',
                                                     folder_11))
                    os.system('start' + ' ' + '"' + '"' + ' ' + '"' + os.path.join('\\\\192.168.1.225', 'LR_Log',
                                                                                   project_11) + '"')
                    ...
                    if ok_11:
                        ...
                        try:
                            shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_AOAC_v5\\EVLogs\\Application.evtx',
                                        os.path.join('\\\\192.168.1.225', 'LR_Log', project_11, new_path_11, 'DC_R',
                                                     new_folder_11))
                        except FileNotFoundError:
                            time.sleep(1)
                        try:
                        ...
                        data_11_11_11 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
            ...
            data_15 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_15:
                ...
                if result_15 == QMessageBox.No:
                    ...
                    os.system('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\\batteryreport.bat')
                    time.sleep(1)
                    try:
                        shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\\EVLogs\\Application.evtx',
                                    os.path.join('\\\\192.168.1.225', 'LR_Log', project_15, path_15, 'FSU',
                                                 folder_15))
                    except FileNotFoundError:
                        time.sleep(1)
                    try:
                        shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\\EVLogs\\System.evtx',
                                    os.path.join('\\\\192.168.1.225', 'LR_Log', project_15, path_15, 'FSU',
                                                 folder_15))
                    except FileNotFoundError:
                        time.sleep(1)
                    if os.path.exists('C:\\Windows\\Memory.DMP'):
                        QMessageBox.information(MainWindow, '提示', '有memorydump生成,若需要请自行在本地收集')
                    if os.path.getsize(
                            'C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\\LongRunATS_Shutdown_Log.htm') == 0:
                        os.system('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\\sleepstudy.bat')
                        time.sleep(7)
                    for file in os.listdir('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5'):
                        if fnmatch.fnmatch(file, '*.htm') or fnmatch.fnmatch(file, '*.html') or fnmatch.fnmatch(file,
                                                                                                                '*.csv'):
                            shutil.move(os.path.join('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5', file),
                                        os.path.join('\\\\192.168.1.225', 'LR_Log', project_15, path_15, 'FSU',
                                                     folder_15))
                    os.system('start' + ' ' + '"' + '"' + ' ' + '"' + os.path.join('\\\\192.168.1.225', 'LR_Log',
                                                                                   project_15) + '"')
                    ...
                    if ok_15:
                        ...
                        data_15_15_15 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
            ...
            data_13 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_13:
                ...
                if result_13 == QMessageBox.No:
                    ...
                    if ok_13:
                        ...
                        data_13_13_13 = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
            ...
            data_13_wf = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_13_wf:
                ...
                if result_13_wf == QMessageBox.No:
                    ...
                    while True:
                        time.sleep(1)
                        if os.path.exists(
                                'C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\\sleepstudy-report.html') == False:
                            continue
                        shutil.move('C:\\TNB_Integration_Tool\\LongRunATS_Shutdown_v5\\sleepstudy-report.html',
                    ...
                    if ok_13_wf:
                        ...
                        data_13_13_13_wf = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
            ...
            data_13_wc = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_13_wc:
                ...
                if result_13_wc == QMessageBox.No:
                    ...
                    if ok_13_wc:
                        ...
                        data_13_13_13_wc = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
            ...
            data_13_wz = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt')
            ...
            if SNnumber in list_13_wz:
                ...
                if result_13_wz == QMessageBox.No:
                    ...
                    if ok_13_wz:
                        ...
                        data_13_13_13_wz = open('C:\\TNB_Integration_Tool\\SetPrerequisites_v3.0\\SUT_config.txt', 'w+')
